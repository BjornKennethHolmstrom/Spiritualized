<script lang="ts">
  ...
  $: defaultTitle = currentLanguage === 'en' 
    ? 'Spiritualized - Being is the Path'
    : 'Spiritualized - Varandet är vägen';
  
  $: defaultDescription = currentLanguage === 'en'
    ? "A quiet refuge to explore spirituality as 'being,' not 'doing.'"
    : "En stilla fristad för att utforska andlighet som ’varande,’ inte ’görande.’";
...
<div class="flex flex-col items-center space-y-4 py-8 border-t border-neutral-200 dark:border-slate-800">
  ...
  <div class="flex space-x-4">
    <a
      ...
      class="p-2 rounded-full bg-neutral-100 dark:bg-slate-800 hover:bg-neutral-200 dark:hover:bg-slate-700 transition-colors text-neutral-700 dark:text-neutral-300"
    ...
    <button
      on:click={copyUrl}
      class="p-2 rounded-full bg-neutral-100 dark:bg-slate-800 hover:bg-neutral-200 dark:hover:bg-slate-700 transition-colors relative group text-neutral-700 dark:text-neutral-300"
    ...
    >
      ...
      {#if copied}
        <span class="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-neutral-700 dark:bg-neutral-300 text-neutral-100 dark:text-neutral-900 text-sm py-1 px-2 rounded whitespace-nowrap">
